...
function sticky(){
    ...
    //SETUP SOME VARS
    var sidebar = $('section').last().find('.sidebar');
    var siteContent = $('section').last().find('.siteContent');
    ...
    if ($('.siteBottom section .siteContent').length > 0) {

        if(lastSite > lastHeight){
        var difference = windowHeight - (totalHeight - lastSite) - 1;

        }
        else {
            var difference = windowHeight - (totalHeight - lastHeight) - 1;
        }
        ...
        if(totalHeight < windowHeight){
            var difference = windowHeight- ( $('.siteTop').outerHeight() + $('footer').outerHeight());
            $('.siteBottom').height(difference);
        }
    }
